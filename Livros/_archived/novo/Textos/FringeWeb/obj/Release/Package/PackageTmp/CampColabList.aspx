<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostBack="true" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CampColabList.aspx.cs" Inherits="MVApp.CampColabList" %>
        ...
        <div class="widget">
            ...
            <tr>
                ...
                <td style="width: 79px">
                    &nbsp;</td>
                <td style="width: 79px">
                    <asp:Button ID="BtnNovo" runat="server" Text="Novo" CssClass="blueB" 
